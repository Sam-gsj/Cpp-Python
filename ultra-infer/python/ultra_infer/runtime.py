...
class Runtime:
    ...
    def infer_gsj(self, data, rows=27, cols=48):
        """Inference with input data.
    ...
    def get_mat_rkmpp(self, url_str):

        return self._runtime.get_mat_rkmpp(url_str) 
    
    def init_mat(self, url_str,ip="192.168.1.35", password="firefly"):

        return self._runtime.init_mat(url_str,ip,password)    
    
    def init_mat_rkmpp(self, url_str,ip="192.168.1.35", password="firefly"):

        return self._runtime.init_mat_rkmpp(url_str,ip,password)  
